    ...
    <svg viewBox="0 0 320 150" className={className} role="img" aria-label={`${type} illustration`}>
      ...
      {type === "sedan" && (
        <g>
          ...
          <path d="M150 66 L150 46" stroke="#16233a" strokeWidth="2" />
        </g>
      )}
      {type === "van" && (
        <g>
          ...
          <path d="M120 52 L120 76 M170 51 L170 76" stroke="#16233a" strokeWidth="2" />
        </g>
      )}
      {type === "minibus" && (
        <g>
          ...
          <path d="M100 54 L100 78 M150 53 L150 78 M200 52 L200 78" stroke="#16233a" strokeWidth="2" />
        </g>
      )}

      {/* Champagne accent line */}
      <path d="M30 104 L296 104" stroke="#c2a15f" strokeWidth="2" opacity="0.7" />
      {/* Wheels */}
      <g>
        <circle cx="96" cy="108" r="22" fill="#0f1626" />
        <circle cx="96" cy="108" r="12" fill="#1b2740" stroke="#c2a15f" strokeWidth="1.5" />
        <circle cx="236" cy="108" r="22" fill="#0f1626" />
        <circle cx="236" cy="108" r="12" fill="#1b2740" stroke="#c2a15f" strokeWidth="1.5" />
      </g>
    </svg>
  );
}
